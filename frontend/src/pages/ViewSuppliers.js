          ...
          <Grid item key={supplier.supplier_id} xs={12} sm={6} md={4}>
            <Card>
              <CardContent>
                ...
                <Typography variant="body2">{supplier.phone_number}</Typography>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', marginTop: 2 }}>
                  ...
                  <Button variant="contained" color="secondary" onClick={() => handleDelete(supplier.supplier_id)}>
                    Delete
                  </Button>
                </Box>
              </CardContent>
